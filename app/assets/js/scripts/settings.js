...
const settingsAcrpContentPath = document.getElementById('settingsAcrpContentPath')
const settingsAcrpContentOpen = document.getElementById('settingsAcrpContentOpen')
if(settingsAcrpContentPath != null) {
    settingsAcrpContentPath.value = path.join(ConfigManager.getLauncherDirectory(), 'acrp-content.json')
}
if(settingsAcrpContentOpen != null) {
    settingsAcrpContentOpen.onclick = () => {
        shell.openPath(path.join(ConfigManager.getLauncherDirectory(), 'acrp-content.json'))
    }
}
...
function populateReleaseNotes(){
    $.ajax({
        url: 'https://github.com/AdventureCity/acrp-launcher/releases.atom',
        success: (data) => {
