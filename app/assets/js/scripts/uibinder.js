...
async function showMainUI(data){
    ...
    setTimeout(() => {
        ...
        document.body.style.backgroundImage = "linear-gradient(90deg, rgba(2, 6, 13, 0.95), rgba(2, 6, 13, 0.35), rgba(2, 6, 13, 0.95)), url('assets/images/backgrounds/acrp-hero.png')"
        $('#main').show()
